...
public class Main {
    public static void main(String[] args) {
        ...
        try {
            ...
            // Calcular el árbol de expansión mínima utilizando el algoritmo de Prim
            String origen = "Universidad Manuela Beltrán Sede Bogotá";
            List<String> arbolExpansionMinima = Prim.prim(grafo, origen);

            System.out.println();
            // Imprimir el árbol de expansión mínima
            System.out.println("Árbol de expansión mínima desde " + origen + ":");
            for (String nodo : arbolExpansionMinima) {
